...
// bai 01
const delayedHelloWorld = new Promise((resolve) => {
...
// bai 02
const delayed10 = new Promise((resolve) => {
...
// bai 10
const simulateTask2 = (time, failed) => {
    return new Promise((resolve, reject) => {
        setTimeout(() => {
            if (failed)
...
bai13();
// bai 14
const multiplyAfterDelay = async (num) => {
    return new Promise(resolve => {
...
bai19();
// bai 20
const fetchUser2 = async (id, delayed = 1000) => {
    return new Promise(resolve => {
        setTimeout(() => {
            resolve({ id, name: `User ${id}` });
        }, delayed);
...
const fetchUserWithTimeout = (id, delayed) => {
...
bai30();
//# sourceMappingURL=Tuan02.js.map